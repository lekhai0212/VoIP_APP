...
- (void)viewDidLoad {
    ...
    btnCancel = [[UIBarButtonItem alloc] initWithTitle:[[LanguageUtil sharedInstance] getContent:@"Cancel"] style:UIBarButtonItemStyleDone target:self action:@selector(resetDataAfterAddContact)];
