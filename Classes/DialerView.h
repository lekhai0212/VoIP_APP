...
@interface DialerView
	: TPMultiLayoutViewController <UITextFieldDelegate, UICompositeViewDelegate, UIGestureRecognizerDelegate, UICallButtonDelegate, SearchContactPopupViewDelegate, WebServicesDelegate> {
}
