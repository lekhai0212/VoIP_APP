...
- (void)viewWillAppear:(BOOL)animated {
    ...
    //  Add new by Khai Le on 05/11/2017
...
- (void)loadAssistantConfig:(NSString *)rcFilename {
    //  linphone_config_read_file(linphone_core_get_config(LC), [LinphoneManager bundleFile:rcFilename].UTF8String);
...
- (IBAction)onLoginClick:(id)sender {
	ONCLICKBUTTON(sender, 100, {
        ...
        NSString *strAddress = [NSString stringWithFormat:@"sip:7788990004@103.237.148.99:51000"];
