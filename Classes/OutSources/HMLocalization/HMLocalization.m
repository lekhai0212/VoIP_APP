...
- (void)setLanguage:(NSString *)languageName {
    ...
    NSString *path = [[NSBundle mainBundle] pathForResource:[languageName lowercaseString]
                                                     ofType:@"txt"];
    ...
    for (NSString *keyAndValue in keysAndValuesArray) {
        ...
        @try {
            ...
            if ([key isEqualToString:@"HMLanguageDirection"]) {
                ...
                [tempLocalizedstrings setObject:value forKey:[key lowercaseString]];
            }
        }
...
- (NSString *)localizedStringForKey:(NSString *)key {
    ...
    NSString *valueForKey = [self.localizedStrings objectForKey:[key lowercaseString]];
