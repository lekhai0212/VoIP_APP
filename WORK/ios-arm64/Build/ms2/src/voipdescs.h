...
MS2_VAR_PUBLIC MSFilterDesc ms_aac_eld_dec_desc;
MS2_VAR_PUBLIC MSFilterDesc ms_aac_eld_enc_desc;
...
MS2_VAR_PUBLIC MSFilterDesc aq_read_desc;
MS2_VAR_PUBLIC MSFilterDesc aq_write_desc;
MS2_VAR_PUBLIC MSFilterDesc au_read_desc;
MS2_VAR_PUBLIC MSFilterDesc au_write_desc;
MS2_VAR_PUBLIC MSFilterDesc ms_iosdisplay_desc;
MS2_VAR_PUBLIC MSFilterDesc ms_ioscapture_desc;
